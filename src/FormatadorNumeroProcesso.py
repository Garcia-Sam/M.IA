...
import re
import logging
import regraOrgao  # Importa o módulo regraOrgao, que deve conter funções para verificar a justiça e o tribunal

# Configura o nível de log para INFO, o que significa que todas as mensagens de INFO e erros serão exibidas
logging.basicConfig(level=logging.INFO)


"""Arquivo para testar ajustes no backend"""
...
def processar_dados_excel(arquivo_entrada, arquivo_saida):
    """
    ...
    aba_judicial = df[df['CATEGORIA'] == 'Judicial - PRU1']
    ...
    # Separa os DataFrames com base na categoria
    dfs = {
        'Judicial - PRU1': aba_judicial,
        'NUP': df[df['CATEGORIA'] == 'NUP'],
        'Inválido': df[df['CATEGORIA'] == 'Inválido'],
        'Outros Orgãos': aba_nao_encontrada,
    }

    # Salva os DataFrames em um arquivo Excel
    salvar_excel(dfs, arquivo_saida)


# Exemplo de uso
arquivo_entrada = 'C:/Users/maced/Documents/AGU/TesteTabelas/ATUAÇÃO_BRASIL_JANEIRO_MAIO_2024.xlsx'
arquivo_saida = 'C:/Users/maced/Documents/AGU/TesteTabelas/2.xlsx'
processar_dados_excel(arquivo_entrada, arquivo_saida)
